...
Vstart=0.5;       	% Silicon Voltage: start (accumulation)
Vstart=Vstart+0.92; %correction for flat band, at flat band voltage, get flat bands
Vend=np*1.4;         		% Silicon Voltage: end   (inversion)
Nvstep=1;         		% number of voltage steps 
%
...
%****************NUMERICAL CONSTANTS******************
%
aregion=4000e-8; % size of classically allowed region (cm)
